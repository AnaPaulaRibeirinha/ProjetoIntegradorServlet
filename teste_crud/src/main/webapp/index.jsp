...
<body>
      ...
      <div class="row">
        <div class="card col card_quarto qart_1">
          <div class="dados_quarto">
            ...
            <a href="quartos.jsp" class="btn btn-primary button_quarto">Mais detalhes</a>
          </div>
        </div>
  ...
  <div id="institucional" class="bloco_conteudo bloco_institucional">
    <div class="bloco_conteudo">
      ...
      <p class="inst-sub">Conheça a história da nossa rede</p>
      <div>
  ...
  <div id="contato" class="bloco_conteudo bloco_contato">
    ...
    <div id="formulario_contato">
      <form class="row col-md-6 container formulario_contato" action="ServletHotel" method="post">
        <div class="col-md-6">
